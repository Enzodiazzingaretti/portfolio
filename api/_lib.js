...
const COOKIE_NAME = 'enzo_session';
...
// public/images/uploads/<slot>-<digits>.webp — no traversal, no arbitrary extensions.
function isAllowedImagePath(path) {
  return /^public\/images\/uploads\/[a-z0-9-]+-\d+\.webp$/.test(path);
}
