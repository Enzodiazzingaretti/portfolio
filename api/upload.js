...
// Slot: un slug simple (web, flyer, blender, etc.). El path final es lo que valida isAllowedImagePath.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ ok: true, path, url: '/images/uploads/' + filename });
  } catch (e) {
