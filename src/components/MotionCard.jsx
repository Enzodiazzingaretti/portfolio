  ...
  return (
    <article className={`motion-card group reveal-on-scroll ${featured}`}>
      <button type="button" onClick={onOpen} className="block w-full text-left">
        <div className="media-lift relative aspect-video overflow-hidden bg-[#0A0A0A]">
          ...
          <div className="absolute left-5 top-5 flex items-center gap-2">
            ...
            <span className="font-mono text-[9px] uppercase tracking-[0.28em] text-white/80">{loopLabel} {String(index + 1).padStart(2, "0")}</span>
          </div>
