  ...
  locales: {
    es: {
      ...
      hero: {
        ...
        description: "Vengo del motion y el 3D. Hoy diseño y programo los sitios que entrego. Basado en Argentina, disponible internacionalmente.",
        location: "Argentina",
      ...
      webProjects: [
        { ...webProjectAssets.pressKit, scrollPreview: true, title: "Presskit para DJ", type: "Web / Diseño", status: "Online", role: "Diseño y desarrollo", description: "Press kit digital para DJ. HTML estático, i18n en 3 idiomas, formulario de contacto con EmailJS, embeds de SoundCloud y sección de fechas.", tags: ["HTML", "CSS", "JavaScript", "EmailJS", "i18n"], features: ["Multiidioma", "Formulario de contacto", "Embeds de SoundCloud", "Sección de fechas"] },
        ...
        { ...webProjectAssets.portfolio, scrollPreview: true, title: "Portfolio Personal", type: "Web / Desarrollo", status: "En progreso", role: "Diseño y desarrollo", description: "Este portfolio. React + Vite + Tailwind, con el hero en Three.js y un filtro ASCII escrito a mano. Adentro hay un lab generativo, panel de administración propio y contenido en tres idiomas.", tags: ["React", "Vite", "Tailwind CSS"], features: ["Filtro ASCII en Three.js", "Lab generativo", "Panel de administración", "Trilingüe"] },
      ...
      flyers: [
        { ...flyerAssets.aguantaderobass, title: "Aguantadero Bass", type: "Flyer", description: "", tags: ["Diseño", "Flyer"] },
        { ...flyerAssets.blastkick, title: "Blastkick", type: "Flyer", description: "Incluye reel animado.", tags: ["Diseño", "Flyer", "Motion"] },
        { ...flyerAssets.blastkickAnoNuevo, title: "Blastkick — Año Nuevo", type: "Flyer", description: "", tags: ["Diseño", "Flyer"] },
        { ...flyerAssets.distRaptisKexxy, title: "Dist. Raptis. Kexxy.", type: "Flyer", description: "", tags: ["Diseño", "Flyer"] },
        { ...flyerAssets.maccari, title: "Maccari", type: "Flyer", description: "", tags: ["Diseño", "Flyer"] },
        { ...flyerAssets.overkill, title: "Overkill", type: "Flyer", description: "", tags: ["Diseño", "Flyer"] },
      ],
      logos: [
        { ...logosAssets.grandgroove, title: "Grandgroove Records", type: "Logo", description: "Incluye versión animada.", tags: ["Logo", "Branding", "Motion"] },
        { ...logosAssets.chicaLunar, title: "Chica Lunar", type: "Logo", description: "", tags: ["Logo", "Branding"] },
      ],
      espacios: [
        ...
        { ...espaciosAssets.recUnderclub, title: "REC Underclub", type: "3D / Arquitectura", description: "Renders y video del espacio.", tags: ["Blender", "Arquitectura", "3D"] },
    ...
    en: {
      ...
      hero: {
        title: "ENZO DIAZ ZINGARETTI",
        description: "I came from motion and 3D. Now I design and build the sites I ship. Based in Argentina, available internationally.",
        location: "Argentina",
      ...
      webProjects: [
        ...
        { ...webProjectAssets.portfolio, scrollPreview: true, title: "Personal Portfolio", type: "Web / Development", status: "In progress", role: "Design and development", description: "This portfolio. React + Vite + Tailwind, with a Three.js hero and a hand-written ASCII post-processing pass. Inside there is a generative lab, a custom admin panel and content in three languages.", tags: ["React", "Vite", "Tailwind CSS"], features: ["Three.js ASCII pass", "Generative lab", "Admin panel", "Trilingual"] },
      ...
      flyers: [
        { ...flyerAssets.aguantaderobass, title: "Aguantadero Bass", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.blastkick, title: "Blastkick", type: "Flyer", description: "Includes an animated reel.", tags: ["Design", "Flyer", "Motion"] },
        { ...flyerAssets.blastkickAnoNuevo, title: "Blastkick — New Year", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.distRaptisKexxy, title: "Dist. Raptis. Kexxy.", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.maccari, title: "Maccari", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.overkill, title: "Overkill", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
      ],
      logos: [
        { ...logosAssets.grandgroove, title: "Grandgroove Records", type: "Logo", description: "Includes an animated version.", tags: ["Logo", "Branding", "Motion"] },
        { ...logosAssets.chicaLunar, title: "Chica Lunar", type: "Logo", description: "", tags: ["Logo", "Branding"] },
      ],
      espacios: [
        ...
        { ...espaciosAssets.recUnderclub, title: "REC Underclub", type: "3D / Architecture", description: "Renders and video of the space.", tags: ["Blender", "Architecture", "3D"] },
    ...
    pt: {
      ...
      hero: {
        title: "ENZO DIAZ ZINGARETTI",
        description: "Venho do motion e do 3D. Hoje desenho e programo os sites que entrego. Baseado na Argentina, disponível internacionalmente.",
        location: "Argentina",
      ...
      webProjects: [
        ...
        { ...webProjectAssets.portfolio, scrollPreview: true, title: "Portfólio Pessoal", type: "Web / Desenvolvimento", status: "Em progresso", role: "Design e desenvolvimento", description: "Este portfólio. React + Vite + Tailwind, com o hero em Three.js e um filtro ASCII escrito à mão. Dentro há um lab generativo, painel de administração próprio e conteúdo em três idiomas.", tags: ["React", "Vite", "Tailwind CSS"], features: ["Filtro ASCII em Three.js", "Lab generativo", "Painel de administração", "Trilíngue"] },
      ...
      flyers: [
        { ...flyerAssets.aguantaderobass, title: "Aguantadero Bass", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.blastkick, title: "Blastkick", type: "Flyer", description: "Inclui reel animado.", tags: ["Design", "Flyer", "Motion"] },
        { ...flyerAssets.blastkickAnoNuevo, title: "Blastkick — Ano Novo", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.distRaptisKexxy, title: "Dist. Raptis. Kexxy.", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.maccari, title: "Maccari", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
        { ...flyerAssets.overkill, title: "Overkill", type: "Flyer", description: "", tags: ["Design", "Flyer"] },
      ],
      logos: [
        { ...logosAssets.grandgroove, title: "Grandgroove Records", type: "Logo", description: "Inclui versão animada.", tags: ["Logo", "Branding", "Motion"] },
        { ...logosAssets.chicaLunar, title: "Chica Lunar", type: "Logo", description: "", tags: ["Logo", "Branding"] },
      ],
      espacios: [
        ...
        { ...espaciosAssets.recUnderclub, title: "REC Underclub", type: "3D / Arquitetura", description: "Renders e vídeo do espaço.", tags: ["Blender", "Arquitetura", "3D"] },
