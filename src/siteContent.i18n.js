  ...
  locales: {
    es: {
      ...
      sections: {
        ...
        contact: { index: "08 / CONTACTO", title: "CONTACTO", subtitle: "Disponible para proyectos freelance y colaboraciones" },
      },
      hero: {
      ...
      ui: {
        ...
        modal: { close: "Cerrar", previous: "Anterior", next: "Siguiente", navigateHint: "← → para navegar · ", closeHint: "ESC para cerrar", year: "Año", role: "Rol", status: "Estado", visitSite: "Abrir sitio" },
    ...
    en: {
      ...
      sections: {
        ...
        contact: { index: "08 / CONTACT", title: "CONTACT", subtitle: "Available for freelance and collaborations" },
      },
      hero: {
        tagline: "3D / Motion / Branding / Web",
        title: "ENZO DIAZ ZINGARETTI",
      ...
      ui: {
        ...
        modal: { close: "Close", previous: "Previous", next: "Next", navigateHint: "← → to navigate · ", closeHint: "ESC to close", year: "Year", role: "Role", status: "Status", visitSite: "Visit Site" },
    ...
    pt: {
      ...
      sections: {
        ...
        contact: { index: "08 / CONTATO", title: "CONTATO", subtitle: "Disponível para freelance e colaborações" },
      },
      hero: {
        tagline: "3D / Motion / Branding / Web",
        title: "ENZO DIAZ ZINGARETTI",
      ...
      ui: {
        ...
        renderTags: ["blender", "3d", "render"],
        contactLabels: { email: "Email", instagram: "Instagram", linkedin: "LinkedIn", profile: "Perfil", presskit: "Press Kit" },
        modal: { close: "Fechar", previous: "Anterior", next: "Próximo", navigateHint: "← → para navegar · ", closeHint: "ESC para fechar", year: "Ano", role: "Papel", status: "Status", visitSite: "Abrir site" },
        footerLocation: "Argentina / Internacional",
        pageTitle: "Portfólio",
